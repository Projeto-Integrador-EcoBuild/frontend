...
function Carrinho() {
    ...
    return (
        <>
            <div className='flex ml-32 cp:ml-1 sm:ml-1 md:ml-20 mt-10 w-1/2 cp:w-full items-center'>
            ...
            <div className=' flex flex-row justify-center cp:ml-1 sm:ml-1 md:ml-20 mt-5 border cp:w-full cp:grid cp:grid-cols-1 mx-44 mb-10 '>
                ...
                <div className=' ml-2 bg-gray-100 w-1/3 h-screen p-5 text-center p-auto md:w-2/5 md:-mr-48 cp:w-full cp:-ml-3 '>
                    <div className=" sticky top-5 ml-3 md:ml-0 ">
