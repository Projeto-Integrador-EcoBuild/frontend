...
function Sobre() {
  ...
  return (
    <div className='dark:bg-gray-fundo dark:text-gray-texto bg-white'>
      {isDarkTheme ? (
      <svg id="visual" viewBox="0 44 900 128" xmlns="http://www.w3.org/2000/svg"  version="1.1"><path d="M0 134L16.7 123.3C33.3 112.7 66.7 91.3 100 84.2C133.3 77 166.7 84 200 103.5C233.3 123 266.7 155 300 158.2C333.3 161.3 366.7 135.7 400 127.3C433.3 119 466.7 128 500 134.8C533.3 141.7 566.7 146.3 600 153.5C633.3 160.7 666.7 170.3 700 158.8C733.3 147.3 766.7 114.7 800 111C833.3 107.3 866.7 132.7 883.3 145.3L900 158L900 0L883.3 0C866.7 0 833.3 0 800 0C766.7 0 733.3 0 700 0C666.7 0 633.3 0 600 0C566.7 0 533.3 0 500 0C466.7 0 433.3 0 400 0C366.7 0 333.3 0 300 0C266.7 0 233.3 0 200 0C166.7 0 133.3 0 100 0C66.7 0 33.3 0 16.7 0L0 0Z" fill="#003023" stroke-linecap="round" stroke-linejoin="miter"></path></svg>
      ): (
      ...
      <div className=' m-auto text-2xl mb-12  flex flex-col  gap-6 w-[80%] text-justify'>
        <h1 className='text-6xl font-light  text-green-hover dark:text-white'>Sobre nós</h1>
      ...
      <h1 className='text-center text-green-hover text-6xl font-light mb-10 dark:text-white'>Nossas missões</h1>
      <div className='flex flex-row  w-[100%] px-20 cp:flex-col'>

        <div className=' w-1/3 cp:mb-6 cp:w-full dark:cp:border-b-white cp:border-b-black cp:border-l-transparent cp:border-r-transparent cp:border-t-transparent dark:cp:border-r-transparent border-r-black dark:border-r-white border-l-transparent border-t-transparent border-b-transparent  border px-4 text-center  items-center justify-center flex flex-col'>
          <h2 className='mb-2 text-2xl font-light dark:font-medium text-green-hover'>Promover a Sustentabilidade</h2>
        ...
        <div className='  w-1/3  cp:w-full dark:cp:border-b-white cp:border-b-black cp:border-l-transparent cp:border-r-transparent cp:border-t-transparent dark:cp:border-r-transparent border-r-black dark:border-r-white  border-l-transparent border-t-transparent border-b-transparent border px-4 text-center  items-center justify-center flex flex-col'>
          <h2 className='mb-2 text-2xl font-light dark:font-medium text-green-hover'>Educar e Conscientizar</h2>
        ...
        <div className=' cp:w-full cp:border-b-transparent cp:border-l-transparent cp:border-r-transparent cp:border-t-transparent w-1/3 px-4 text-center   items-center justify-center flex flex-col'>
          <h2 className='cp:mt-6 mb-2 text-2xl dark:font-medium font-light text-green-hover' >Inovação e Tecnologia</h2>
      ...
      <h1 className='text-center text-green-hover text-6xl font-light mt-28 cp:mx-10 sm:mx-14 dark:text-white'>Conheça nossa equipe ! </h1>
